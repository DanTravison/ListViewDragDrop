...
/// <summary>
/// Provides an <see cref="ICommandEx"/> base class.
/// </summary>
public class CommandEx : ObservableObject, ICommandEx
{
    #region Static
    ...
    /// </summary>
    static public readonly Action<ICommandEx> NoAction = (Command) => { };
    ...
    public CommandEx(Action<ICommandEx> action)
    ...
    public CommandEx(Action<ICommandEx> action, bool isEnabled)
    ...
    public CommandEx(Action<ICommandEx> action, bool isEnabled, string text)
    ...
    /// <param name="isEnabled">true if the command is enabled; otherwise, false.</param>
    /// <param name="text">The display text to associate with this instance.</param>
    public CommandEx(Action<ICommandEx> action, bool isEnabled, string text, string description)
        : base()
    {
    ...
    /// </summary>
    public Action<ICommandEx> Action
    {
        get;
    }
